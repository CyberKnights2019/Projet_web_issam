                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Liste des Livreurs</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card" style="    width: 700px;">
                                ...
                                <div class="card-body">
                                  <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Chercher par prénom" title="Chercher un livreur">
<button onclick="printData()">Imprimer</button>
                                    <table class="table table-striped" id="myTable" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th scope="col" onclick="sortTable(0)">CIN</th>
                                                <th scope="col" onclick="sortTable(1)">Nom</th>
                                                <th scope="col" onclick="sortTable(2)">Prenom</th>
                                                <th scope="col" onclick="sortTable(3)">Tel</th>
                                                <th scope="col" onclick="sortTable(4)">E-Mail</th>
                                                <th scope="col" onclick="sortTable(5)">Adresse</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach($listeLivreurs as $row){
                                              ...
                                              <td><?PHP echo $row['Tel']; ?></td>
                                            	...
                                            	<td><form method="POST" action="Supprimer_Livreur.php">
                                            	<input type="submit" name="supprimer" value="Effacer">
                                            	<input type="hidden" value="<?PHP echo $row['CIN']; ?>" name="cinL">
                                            	</form>
                                            	</td>
                                            	<td><a href="Modifier_Livreur.php?cin=<?PHP echo $row['CIN']; ?>">
                                            	Modifier</a></td>
                                            	</tr>
                                            	<?PHP
                                            }
